...
interface SEOHeadProps extends Partial<SEOMetadata> { type?: 'website' | 'article' | 'profile'; jsonLd?: Record<string, unknown>; }
...
export const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  canonical = "https://arititemesgen.com",
  keywords = ["Ariti Temesgen Wayu", "Software Developer Ethiopia", "Full Stack Developer Ethiopia", "React Developer Ethiopia", "Node.js Developer Ethiopia", "Freelance Web Developer Ethiopia", "Ethiopia Software Engineer", "SmartSpend", "AgriConnect Ethiopia", "PharmaCore Ethiopia"],
  ...
  useEffect(() => {
    ...
    const schemaGraph = jsonLd ? [jsonLd] : [
      {
        ...
        "@type": "Person",
        "@id": "https://arititemesgen.com/#person",
        "name": "Ariti Temesgen Wayu",
        "jobTitle": "Full-Stack Software Developer",
        "url": canonical,
        "email": "mailto:arititemesgen16@gmail.com",
        "telephone": "+251916007076",
        "sameAs": ["https://github.com/AritiTemesgen16", "https://linkedin.com/in/Arititemesgen", "https://t.me/arititemesgen"],
        "address": { "@type": "PostalAddress", "addressLocality": "Addis Ababa", "addressCountry": "Ethiopia" },
        "knowsAbout": ["Software Engineering", "JavaScript", "TypeScript", "React 18", "Node.js", "Express.js", "PostgreSQL", "MongoDB", "Database Architecture", "Business Management Systems", "Full-stack Web Applications"],
        "knowsLanguage": ["English", "Amharic", "Afaan Oromo"],
        "alumniOf": [{ "@type": "EducationalOrganization", "name": "Computer Science Degree Program" }, { "@type": "EducationalOrganization", "name": "Management Degree Program" }]
      },
      {
        "@context": "https://schema.org",
        "@type": "WebSite",
        "@id": "https://arititemesgen.com/#website",
        "url": "https://arititemesgen.com",
        ...
        "publisher": { "@id": "https://arititemesgen.com/#person" },
        "inLanguage": "en-US"
      }
    ];
    ...
    scriptTag.textContent = JSON.stringify({ "@context": "https://schema.org", "@graph": schemaGraph });
